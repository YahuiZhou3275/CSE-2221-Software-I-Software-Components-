...
public final class RSSReader {
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        if (linkInd != -1) {
            ...
            // when title is avaible
            // check if the title text is available
            // if it is, link the title text to the url
            // if it is not, link "No title available" to the url
            if (titleItemInd != -1) {
                if (item.child(titleItemInd).numberOfChildren() != 0) {
                    String titleText = item.child(titleItemInd).child(0)
                            .label();
                ...
                // if it is, link the description text to the url
                // if it is not, link "No description" to the url
            ...
            if (titleItemInd != -1) {
                ...
                // if it is not, fill "No description available" instead.
    ...
    public static void main(String[] args) {
        ...
        if (name.equals("rss")) {
            if (t.hasAttribute("version")) {
                String value = t.attributeValue("version");
                if (value.equals("2.0")) {
                    isRss = true;
                }
            }
