...
/**
 * First，the user is prompted to enter a constant miu. Then, the user need to
 * enter four positive real value not equal to 1. The program do a calculation
 * and find the combination of exponents that minimizes the error of the
 * approximation of miu and then print the exponents, best approximation, and
...
public final class ABCDGuesser2 {
    ...
    private static double getPositiveDoubleNotOne(SimpleReader in,
        ...
        while (num <= 0 || num == 1) {
            ...
            while (num == 1) {
                out.println("Your input should not equal to 1.0.");
                out.print(
    ...
    /**
     * Try the exponents one by one. Find and print the best approximation, the
     * exponents, and corresponding relative error.
     *
     * @param m
     ...
     * @param miu
     *            the positive real-valued number should be approximated
     * @param out
     *            the output stream
     */
    private static void calculateExponents(double m, double n, double p,
            double q, double[] exponents, double miu, SimpleWriter out) {
         ...
         * least relative error. Report the best approximation and the relative
         * error.
         */
    ...
    public static void main(String[] args) {
        ...
        /*
         * Ask for four positive real-valued numbers for a, b, c, d.
         */
         ...
         */
        calculateExponents(m, n, p, q, exponents, miu, out);
